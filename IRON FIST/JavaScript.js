Swal.fire({
    title : '¿Preparado para salvar el mundo? <br><br> <img src="IMG/tierra_intro.gif" width = "120px"><br>',
    html: '<strong>DESTRUCTION PLANET</strong>, es un juego que mejorara tus reflejos a medida que pases de nivel, retandote cada vez mas a medida que avances y desbloqueando grandes logros al final de cada nivel, esperamos te diviertas y disfrutes de este gran juego   ',
...
document.getElementById("Recursos").style.background = "gray"
document.getElementById("Contenedor_RC").style.border =" 3px solid gray"
document.getElementById("title").style.color = "black"
document.getElementById("title").style.webkitTextStroke = "0.01px white"
document.getElementById("subtitle").style.color = "black"
document.getElementById("subtitle").style.webkitTextStroke = "0.01px white"
document.getElementById("Fondo").style.background = "url(IMG/background_main.jpg)"
...
document.getElementById("Fondo").style.backgroundSize = "100% 100%"
document.getElementById("Fondo").style.transition = ".3s ease all"
Graficos = 2}
else{
document.getElementById("Recursos").style.marginLeft = "0%"
document.getElementById("Recursos").style.background = "white"
document.getElementById("Contenedor_RC").style.border =" 3px solid white"
document.getElementById("title").style.color = "white"
document.getElementById("subtitle").style.color = "white"
document.getElementById("Fondo").style.backgroundImage = "url(IMG/background_main.gif) "
Graficos = 1
}
}
