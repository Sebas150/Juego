    ...
    function Aumentar_Puntoslvl2() {
        ...
        if (Puntajelvl2 == 2) {
            ...
            function Ganaste_Pantallalvl2() {
                ...
                document.getElementById("Meteioritolvl2").style.left = "-60%"
                document.getElementById("Meteioritolvl2").style.transition = "0s"

                document.getElementById("Meteiorito2lvl2").style.left = "-60%"
                document.getElementById("Meteiorito2lvl2").style.transition = "0s"

                document.getElementById("Meteiorito3lvl2").style.left = "-60%"
...
function DETENER_JUEGOlvl2() {
    ...
    function PAUSElvl2() {
        ...
        if (Activolvl2 == 1) {
            ...
            Restar_Tiempolvl2 = setInterval(Tiempo_Disminurlvl2, 2000)
